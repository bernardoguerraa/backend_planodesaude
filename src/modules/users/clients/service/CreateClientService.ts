...
export class CreateClientService
 implements Service<Model<Client>, Client>{
    ...
    const treatedClient = { ...client };
        if(!existingProfile){
            ...
            const encryptedPassword = await createHash.generateHash(client.profile.password);
        ...
        createCliente.profile.permissions= await this.permissionsRepository.addUserPermissions(
